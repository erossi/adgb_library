...
<?
	...
	echo "            <td align=\"left\"  valign=\"middle\"><input type=\"text\" name=\"f_collocation\" value=\"" . $arr['collocazione'] . "\" maxlength=\"1\" size=\"3\" align=\"absmiddle\"></td>\n";
	echo "        </tr>\n";
	echo "        <tr>\n";
	...
	echo "            <td>\n";
	echo "                <input type=\"text\" name=\"f_shelf\" value=\"" . $arr['scaffale'] . "\" maxlength=\"1\" size=\"3\" align=\"absmiddle\">&nbsp;/&nbsp;\n";
	echo "                <input type=\"text\" name=\"f_number\" value=\"" . $arr['numero'] . "\" maxlength=\"3\" size=\"5\" align=\"absmiddle\">\n";
	echo "            </td>\n";
	echo "        </tr>\n";
	echo "        <tr>\n";
	echo "            <td>&nbsp;</td>\n";
	...
	echo "        <br>\n";
	echo "        Please note: it is not necessary to fill in <i>every</i> box\n";
	echo "        but title and an unique collocation/shelf/number are mandatory.\n";
	echo "        </div>\n";
	echo "        </font>\n";
	echo "    </td>\n";
	echo "</tr>\n";
