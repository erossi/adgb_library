...
<?
    ...
    echo "            <input type=\"submit\" value=\"Select user this book\">\n";
    echo "            <select name=\"f_order\" size=\"1\">\n";
    echo "  	          <option value=\"s\">Sorted by surname</option>\n";
    echo "  	          <option value=\"i\">Sorted by ID card</option>\n";
    echo "                <option value=\"u\">Unsorted</option>\n";
    echo "            </select>\n";
    echo "        <td>\n";
    echo "    </tr>\n";
    echo "    </table>\n";
